...
function View_product() {
    ...
    const { ne_id } = useParams();
    const [data, setData] = useState([]);
    const fetch = async () => {
        const res = await axios.get(`http://localhost:3000/Products?id=${ne_id}`);
        ...
        <div>
            ...
            <div class="container-fluid bg-secondary mb-5" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1612423284934-2850a4ea6b0f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', width: '100%' }}>
                <div class="d-flex flex-column align-items-center justify-content-center" style={{ height: '300px' }}>
                    <h1 class="font-weight-semi-bold text-uppercase mb-3">View Product</h1>
                                    ...
                                    <div id="product-carousel" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner" style={{ height: '500px', width: "400px" }}>
                                            ...
                                            <div class="carousel-item" >
                                                <img class="w-100 h-100" src={value.secndIMG} alt="Image" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center mb-4 pt-2">
                                        <div class="input-group quantity mr-3" style={{ width: "130px" }}>
                                            <div class="input-group-btn">
                                                <button class="btn btn-dark btn-minus" onClick={()=>minus()}>
                                                    <i class="fa fa-minus"></i>
                                                </button>
                                            </div>
                                            <button type="text" class="form-control bg-secondary text-center">{count}</button>
                                            <div class="input-group-btn">
                                                <button class="btn btn-dark btn-plus" onClick={()=>plus()}>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="media mb-4">
                                            <img src="Website/img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style={{ width: "45px;" }} />
                ...
                <div class="row px-xl-5">
                    <div class="col">
                        <div class="owl-carousel related-carousel">
                            <div class="card product-item border-0" style={{ height: "530px" }}>
                                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                    <img class="img-fluid w-100" src="https://i.pinimg.com/736x/8d/1e/99/8d1e99e587cf18dd28dac59a3f7a2d4d.jpg" alt="" />
                                </div>
                            ...
                            <div class="card product-item border-0" style={{ height: "530px" }}>
                                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                    <img class="img-fluid w-100" src="https://i.pinimg.com/564x/4e/09/ad/4e09ad596bf75f1bb2e1b075e1b8710c.jpg" alt="" />
                                </div>
                                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                    <h6 class="text-truncate mb-3">Colorful Stylish Shirt</h6>
                                    <div class="d-flex justify-content-center">
                            ...
                            <div class="card product-item border-0" style={{ height: "530px" }}>
                                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                    <img class="img-fluid w-100" src="https://i.pinimg.com/564x/81/c2/b0/81c2b0d6329fd3eb4ed6c13d0c30df67.jpg" alt="" />
                                </div>
                                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                    <h6 class="text-truncate mb-3">Colorful Stylish Shirt</h6>
                                    <div class="d-flex justify-content-center">
                            ...
                            <div class="card product-item border-0" style={{ height: "530px" }}>
                                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                    <img class="img-fluid w-100" src="https://i.pinimg.com/736x/5f/9b/fc/5f9bfc66f60a84189370c16594b2eec7.jpg" alt="" />
                                </div>
                                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                    <h6 class="text-truncate mb-3">Colorful Stylish Shirt</h6>
                                    <div class="d-flex justify-content-center">
                            ...
                            <div class="card product-item border-0" style={{ height: "530px" }}>
                                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                    <img class="img-fluid w-100" src="https://i.pinimg.com/736x/8a/38/fb/8a38fb232470798a370b5d652b43d4d6.jpg" alt="" />
                                </div>
                                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                    <h6 class="text-truncate mb-3">Colorful Stylish Shirt</h6>
                                    <div class="d-flex justify-content-center">
